...
{p 4 4 2}
A more extensive {it:{help pcn##description:description}} is available {help pcn##description:below}.{p_end}
...
Sections are presented under the following headings:
                ...
                {it:{help pcn##subcommands:Subcommands description}}
		  - {it:{help pcn##subload:load}}
...
{p 8 17 2}
{cmdab:pcn:} [{it:{help pcn##subcommands:subcommand}}] [{cmd:,} 
{opt countr:ies(3-letter code)} {opt year(####)} {opt type(string)} 
{it:{help pcn##options:Options}}]{p_end}
...
[{opt type:(string)} {opt maindir:(string)} {opt vermast:(#)} {opt veralt:(#)} 
{opt pause} {opt clear} {it:{help pcn##options:Options}} ]{p_end}
